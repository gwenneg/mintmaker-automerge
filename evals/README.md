...
| `python` | pyproject and requirements with Django, no toolchain or container file (Steps 4 and 6 skipped), path-filtered PR pipeline, existing `renovate.jsonc` kept in place, unknown default branch |
